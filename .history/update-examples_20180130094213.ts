...
async function copyFiles(srcFolder: string, srcFilesGlob: string, destFolder: string, destExt: string, removeTypes: boolean, additionalReplacements): Promise<void> {
    try {
