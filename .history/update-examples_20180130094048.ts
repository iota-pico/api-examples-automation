...
awai deleteFiles("../iota-pico-examples-nodejs-js/src/", ".js");
...
deleteFiles("../iota-pico-examples-browser-ts/src/", ".ts");
copyFiles("../iota-pico-examples-nodejs-ts/src/api/", "**/!(*.d).ts", "../iota-pico-examples-browser-ts/src/api", ".js", true);
copyFiles("../iota-pico-examples-nodejs-ts/src/", "networkConfig.ts", "../iota-pico-examples-browser-ts/src", ".js", true);
copyFiles("../iota-pico-examples-nodejs-ts/src/", "typings.d.ts", "../iota-pico-examples-browser-ts/src", ".d.ts", false);
