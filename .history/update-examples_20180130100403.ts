...
async function doAll(): Promise<void> {
    ...
    await copyFiles("../iota-pico-examples-browser-ts/", "index.html", "../iota-pico-examples-browser-js/", ".html", false);
    await copyFiles("../iota-pico-examples-browser-ts/src/", "index.html", "../iota-pico-examples-browser-js/", ".html", false);
}
